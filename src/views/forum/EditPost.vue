<template>
    <div class="edit-post">
        <el-form :model="formData" :rules="rules" ref="formDataRef" label-width="80px" class="post-panel">
            <!-- 左边 -->
                ...
                <el-card>
                    <template #header>
                        <div class="post-editor-title">
                            ...
                            <div class="change-editor-title" @click="editorChange">
                    ...
                    <el-form-item prop="content" label-width="0">
                        ...
                        <EditorMarkdown @htmlContent="setHtmlContent" :height="makerdownHeight" v-if="editorType == 1"
            ...
            <div class="post-setting">
                <el-card>
                    ...
                    <div class="setting-inner"> <!-- input输入 -->
                        <el-form-item label="标题" prop="title">
                            <el-input v-model="formData.title" clearable placeholder="提示信息">
                            </el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="摘要" prop="summary">
                            <el-input clearable placeholder="提示信息" type="textarea" :rows="5" :maxlength="200" resize="none"
                                show-word-limit v-model="formData.summary"></el-input>
                        </el-form-item>
...
const makerdownHeight = window.innerHeight - 60 - 60;
...
const getArticleDetail = () => {
    nextTick(async () => {
        ...
        if (articleId.value) {
            ...
            let articleInfo = result.data.formArticle
            //设置编辑器
            ...
            if (articleInfo.boardIds != null && articleInfo.boardId != 0) {
...
const editorChange = () => {
    proxy.Confirm("切换编辑器会清空正在编辑的内容，确认要进行切换吗？", () => {
