        ...
        <div class="article-item-inner">
            <div class="article-body">
                <div class="user-info">
                    ...
                    <router-link :to="'/user/' + data.userId" class="nick-name">{{ data.nickName }}</router-link>

                    <el-divider direction="vertical"></el-divider>
                    <span class="post-name">{{ data.postTime }}</span>
                    <span class="ip-dress">&nbsp;·&nbsp;{{ data.userIpAddress }}</span>
                    <el-divider direction="vertical"></el-divider>
             
                    <router-link :to="`/forum/${data.pBoardId}`" class="nick-name">{{data.pBoardName}}</router-link>
                    <template v-if="data.boardName">
                        <span>&nbsp;/&nbsp;</span>
                        <router-link :to="`/forum/${data.pBoardId}/${data.boardId}`" class="nick-name">{{ data.boardName}}</router-link>
                    </template>
