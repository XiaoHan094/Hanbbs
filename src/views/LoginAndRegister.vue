    ...
    <div>
        ...
        <el-form class="login-register" :model="formData" :rules="rules" ref="formDataRef">
            ...
            <el-form-item prop="password" v-if="opType == 1">
                <el-input 
                :type="
                passwordEyeType.passwordEyeOpen ? 'text' : 'password'"
                size="large"
                clearable
                placeholder="请输入密码"
          ...
          <div v-if="opType == 0||opType == 2">
            ...
            class="send-mail-btn" @click="getEmailCode">获取验证码</el-button>
              ...
              <div>
                ...
                <p>
                  3、将邮箱【1320764010@qq.com】添加到白名单不知道怎么设置？
                </p>
              </div>
              <template #reference>
...
const checkCodeUrl4SendMailCode = ref(api.checkCode);//这个是校验是否给此邮箱发验证码的图片验证码弹框
